		...
		for(k=0;k<list.length;k++){
			if(parseInt(list[k].nameLen) > 0){
				...
				for(k1=0;k1<parseInt(list[k].nameLen);k1++){
					if(list[k+k1].sjjbsj_a){
						list[k].hourtotal += parseFloat(list[k+k1].sjjbsj_a);
					}
					if(list[k+k1].sjjbsj_b){
						list[k].hourtotal += parseFloat(list[k+k1].sjjbsj_b);
					}
					if(list[k+k1].sjjbsj_c){
						list[k].hourtotal += parseFloat(list[k+k1].sjjbsj_c);
					}
				}
			}
		}
